  ...
  <div class="">
    <header class="relative h-60">
      <div class="h-full flex flex-col justify-center items-center text-center">
        ...
        <p class="mt-4 text-lg md:text-xl text-gray-800 dark:text-gray-300 text-center">
    ...
    <main class="container mx-auto px-4 py-4">
      ...
      <section v-if="!isAuthenticated" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <router-link
            class="flex flex-col items-center text-center bg-gray-300 dark:bg-gray-800 rounded-lg p-6 shadow-md transition-transform transform hover:scale-105"
            to="/live-webcams"
        >
          <VideoCameraIcon class="w-12 h-12 text-indigo-500 mb-4"/>
        ...
        <router-link
            ...
            to="/live-webcams"
        >
          <ClockIcon class="w-12 h-12 text-indigo-500 mb-4"/>
        ...
        <router-link
            ...
            to="/favorites"
        >
          <HeartIcon class="w-12 h-12 text-indigo-500 mb-4"/>
      ...
      <section v-else>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <router-link
              ...
              to="/profile"
          >
            <UserIcon class="w-12 h-12 text-indigo-500 mb-4"/>
